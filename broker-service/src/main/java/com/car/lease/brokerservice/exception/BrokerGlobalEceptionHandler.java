...
@Slf4j
public class BrokerGlobalEceptionHandler extends ResponseEntityExceptionHandler{
	...
	// ---------------------------- Custom Exceptions ----------------------------
		...
		@ExceptionHandler({ BrokerSystemException.class })
		public ResponseEntity<ErrorResponse> handleBrokerSystemException(BrokerSystemException e) {
